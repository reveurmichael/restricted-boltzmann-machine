rootf='/Users/yiqing/Desktop/rbmmhc/rbm-mhc'
...
if yesreal == 0 or makereweighting or cond:
    filename_lab = rootf + '/mhc_ligand_full 4.csv'
...
iedb_data_fl_ntempg = convert_letter(iedb_data_fl_ntemp)
OLlist = zip(iedb_data_fl, iedb_data_fl_ntempg)
OLstr = 'Data' + '\t'+ 'Data aligned'
with open(out_fold + '/Table_training_' +  out_par + '.txt', 'w') as out_f:
    out_f.write(OLstr + '\n')
